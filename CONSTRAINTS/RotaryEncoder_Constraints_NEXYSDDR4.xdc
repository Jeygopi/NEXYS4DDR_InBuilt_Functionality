...
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports reset]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports enable]
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports A]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports B]
