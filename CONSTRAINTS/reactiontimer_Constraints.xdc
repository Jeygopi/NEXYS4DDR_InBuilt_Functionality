...
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports decimalPoint]

set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports startBtn]
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports testmodeBtn] 
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports previousTimeBtn]
